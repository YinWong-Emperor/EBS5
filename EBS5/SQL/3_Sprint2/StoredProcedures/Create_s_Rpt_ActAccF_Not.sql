/****** Object:  StoredProcedure [dbo].[s_Rpt_ActAccF_Not]    Script Date: 2017/11/27 10:41:20 ******/
SET ANSI_NULLS ON
GO
...
-- Description : Search Procedure FOR s_Rpt_ActAccF_Not
-- ============================================= */

IF OBJECT_ID('[dbo].[s_Rpt_ActAccF_Not]') > 0
BEGIN
	DROP PROCEDURE [dbo].[s_Rpt_ActAccF_Not]
END
GO


CREATE PROCEDURE [dbo].[s_Rpt_ActAccF_Not]	
	@g2fbDB nvarchar(100),
	@lastday NVARCHAR(50)
AS
BEGIN
...
--EXEC [s_Rpt_ActAccF_Not] '[G2BF_UAT].g2fb_dev' ,'20150101'