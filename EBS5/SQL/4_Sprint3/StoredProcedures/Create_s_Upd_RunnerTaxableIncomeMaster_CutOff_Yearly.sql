...
IF  EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[s_Upd_RunnerTaxableIncomeMaster_CutOff_Yearly]') AND TYPE IN (N'P', N'PC'))
	DROP PROCEDURE [dbo].[s_Upd_RunnerTaxableIncomeMaster_CutOff_Yearly]
GO


CREATE PROCEDURE [dbo].[s_Upd_RunnerTaxableIncomeMaster_CutOff_Yearly]
	@user varchar(30)
AS
BEGIN
