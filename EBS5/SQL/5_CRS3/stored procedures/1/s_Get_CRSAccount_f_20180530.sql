...
/****** Object:  StoredProcedure [dbo].[s_Get_CRSAccount_f_20180530]    Script Date: 09/19/2019 14:49:05 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[s_Get_CRSAccount_f_20180530](
	@g2bDB nvarchar(100)
)
AS
		...
		crs_info AS(
			SELECT 
				...
				a.[CrsType],a.[ClientName],a.[FirstName],a.[LastName],a.[NameType],a.[AccHolderType],a.[CPType],a.[ResCountryCode]
				   ,a.[TIN],a.[TINIssueBy],a.[BR_ID],a.[BirthDate],ISNULL(a.[BirthCountryCode],'''') AS BirthCountryCode,a.[AddressCountryCode],a.[AddressFree],a.[AccBal],
