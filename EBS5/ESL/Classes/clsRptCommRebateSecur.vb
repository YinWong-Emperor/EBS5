...
Public Class clsRptCommRebateSecur
    ...
    Protected Friend Function PrintTotalCommSRpt(ByVal txmonth As String, ByVal ae As String, _
        ByVal range As Decimal, ByVal strSummary As String, ByVal strAEName As String) As ReportClass
        Dim rpt As New RptCommRebateSecur
        Dim ldtDetail As DataTable = lFncCalTotalComm(txmonth, ae, range)
        rpt.SetDataSource(ldtDetail)

        If Not String.IsNullOrEmpty(ae) Then
            Dim textobjects As CrystalDecisions.CrystalReports.Engine.TextObject
            textobjects = rpt.ReportDefinition.ReportObjects("Text1")
            textobjects.Text = "AE      : " & ae & " - " & strAEName & ""
            textobjects = rpt.ReportDefinition.ReportObjects("Text5")
            textobjects.Text = "AE      : " & ae & " - " & strAEName & ""
        End If
    ...
    Protected Friend Function lFncCalTotalComm(ByVal txmonth As String, ByVal ae_no As String, ByVal range As Decimal) As DataTable
        ...
        For row As Integer = 0 To ldtDetail.Rows.Count - 1
            ...
            'End If
            ldtDetail.Rows(row).Item("Rebate") = 0
        Next
        If ae_no <> "" Then
