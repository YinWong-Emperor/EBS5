...
Public Class ClsRptDebitBalCon
    ...
    Protected Friend Function lFncPrepareMC(ByVal lstrQuery As String, ByVal lstrSort As String, ByVal MC As String) As DataTable
        ...
        '        " FROM stcltmaster mst LEFT JOIN  stcltliq liq ON  mst.clt_code = liq.clt_code " & _
        ...
        lstrSQL = " select * from STPortfolio " & _
                ...
                " LEFT JOIN  stcltliq liq ON  mst.clt_code = liq.clt_code " & _
                 lstrQuery & ")  "
