...
Public Class ClsStockOptionsAlertMaster
    Dim EmailDT As DataTable
    Dim clsRpt As New ClsReports

    Protected Friend Function GetMkt() As DataSet
        Dim query As String = "select distinct market from stock_options_product_master "
    ...
    Protected Friend Function SearchAlert(ByVal condition As String) As DataSet
        ...
        " from stock_options_product_master where 1=1 " & condition & " order by product_code asc"
    ...
    Protected Friend Function ModifyProductMaster(ByVal Code As String, ByVal Condition As String) As Boolean
        ...
        Dim sql As String = "Update stock_options_product_master Set " & Condition & " where product_code ='" & Code & "'"
        Try
    ...
    Protected Friend Function AddRecord(ByVal Condition As String) As Boolean
        Dim MyTrans As SqlTransaction = Nothing

        Dim sql As String = "insert into stock_options_product_master " & Condition
        Try
            MyTrans = GSCnSqlConn.BeginTransaction
            GFncRunSQL(GSCnSqlConn, MyTrans, sql, 0)
            'GFncRunSQL(GSCnSqlConn, MyTrans, sql_log, 0)
    ...
    Protected Friend Function EmailRefresh() As DataTable
        ...
        Dim query As String = "Select misc_desc as Email from misc_master where misc_type='MAILALERT' and misc_code= 'STOCK_OPTIONS'"
    ...
    End Function
    Protected Friend Function isRecordExist(ByVal pProductCode As String) As Boolean
        Dim query As String = "Select * from stock_options_product_master where product_code='" & pProductCode & "'"
    ...
    Protected Friend Function EmailAdd(ByVal Address As String) As Boolean
        Dim MyTrans As SqlTransaction = Nothing
        Dim sqlDel As String = " Delete from misc_master where misc_type='MAILALERT' and  misc_code='STOCK_OPTIONS'"
        Dim sql As String = " Insert into misc_master (misc_type, misc_code, misc_desc) Values ( 'MAILALERT', 'STOCK_OPTIONS', "
        Try
            MyTrans = GSCnSqlConn.BeginTransaction
