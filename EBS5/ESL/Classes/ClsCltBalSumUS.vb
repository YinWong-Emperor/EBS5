...
Public Class ClsCltBalSumUS
    ...
    Protected Friend Function lFncGetAECode() As DataSet
        ...
        lstrSQL = "SELECT DISTINCT stcltmaster_US.run_code as aeno FROM stcltmaster_US ORDER BY stcltmaster_US.run_code "
    ...
    Protected Friend Function lFncGetGroupBal(ByVal MyTrans As SqlTransaction, ByVal Dr_Bal As Double, _
        ...
        lstrSQL = "select tdate, isnull(c.run_code, '') as run_code, isnull(c.run_name, '') as run_name, " & _
                    ...
                    "into #AEGrPDrBal " & _
                    "from " & GStrBalDB & ".dbo.acbal_US a " & _
                    "left outer join stcltmaster_US b on a.accno =b.clt_code collate database_default " & _
    ...
    '                            "from balance.dbo.acbal_US a left outer join stcltmaster_US b on a.accno =b.clt_code collate database_default " & _
