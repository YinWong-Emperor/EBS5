...
Public Class rptAEDetail_ICBC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptAEDetail_ICBC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAEDetail_ICBC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAEDetail_ICBC = New rptAEDetail_ICBC()
        rpt.Site = Me.Site
        Return rpt
    End Function
