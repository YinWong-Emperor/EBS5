...
Public Class RptRepledgeDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptRepledgeDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_condition() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptRepledgeDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRepledgeDetail = New RptRepledgeDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
