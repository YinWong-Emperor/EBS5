...
Public Class rptCIES_Opn_Position
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCIES_Opn_Position.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptCIES_Opn_Position.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCIES_Opn_Position
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCIES_Opn_Position = New rptCIES_Opn_Position()
        rpt.Site = Me.Site
        Return rpt
    End Function
