...
Public Class rptNewedgeTrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptNewedgeTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoofTranAdj() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptNewedgeTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewedgeTrans = New rptNewedgeTrans()
        rpt.Site = Me.Site
        Return rpt
    End Function
