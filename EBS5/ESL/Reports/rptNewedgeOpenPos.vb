...
Public Class rptNewedgeOpenPos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptNewedgeOpenPos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewedgeOpenPos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewedgeOpenPos = New rptNewedgeOpenPos()
        rpt.Site = Me.Site
        Return rpt
    End Function
