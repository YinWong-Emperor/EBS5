...
Public Class RptDailyNetTrade
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptDailyNetTrade.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDailyNetTrade
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDailyNetTrade = New RptDailyNetTrade()
        rpt.Site = Me.Site
        Return rpt
    End Function
