...
Public Class RptCommSchemeAE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommSchemeAE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommSchemeAE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommSchemeAE = New RptCommSchemeAE()
        rpt.Site = Me.Site
        Return rpt
    End Function
