...
Public Class rptNewedgeAutoMatch
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptNewedgeAutoMatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptNewedgeAutoMatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewedgeAutoMatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewedgeAutoMatch = New rptNewedgeAutoMatch()
        rpt.Site = Me.Site
        Return rpt
    End Function
