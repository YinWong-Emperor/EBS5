...
Public Class RptNewedgeCommDiff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptNewedgeCommDiff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNewedgeCommDiff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNewedgeCommDiff = New RptNewedgeCommDiff()
        rpt.Site = Me.Site
        Return rpt
    End Function
