...
Public Class rptCIES_Fund_Movement
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCIES_Fund_Movement.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptCIES_Fund_Movement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCIES_Fund_Movement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCIES_Fund_Movement = New rptCIES_Fund_Movement()
        rpt.Site = Me.Site
        Return rpt
    End Function
