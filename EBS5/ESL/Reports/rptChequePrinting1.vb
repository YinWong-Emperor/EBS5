...
Public Class rptChequePrinting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptChequePrinting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChequePrinting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChequePrinting = New rptChequePrinting()
        rpt.Site = Me.Site
        Return rpt
    End Function
