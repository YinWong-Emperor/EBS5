...
Public Class RptCommSchemeRateF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommSchemeRateF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommSchemeRateF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommSchemeRateF = New RptCommSchemeRateF()
        rpt.Site = Me.Site
        Return rpt
    End Function
