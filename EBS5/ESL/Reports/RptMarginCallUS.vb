...
Public Class RptMarginCallUS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptMarginCallUS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMarginCallUS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMarginCallUS = New RptMarginCallUS()
        rpt.Site = Me.Site
        Return rpt
    End Function
