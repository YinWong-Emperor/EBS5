...
Public Class RptTransAdjDiff_s
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptTransAdjDiff_s.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTransAdjDiff_s
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTransAdjDiff_s = New RptTransAdjDiff_s()
        rpt.Site = Me.Site
        Return rpt
    End Function
