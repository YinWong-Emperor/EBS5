...
Public Class rptRepledgedSubClient
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRepledgedSubClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptRepledgedSubClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepledgedSubClient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepledgedSubClient = New rptRepledgedSubClient()
        rpt.Site = Me.Site
        Return rpt
    End Function
