...
Public Class RptCommSchemeAE2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommSchemeAE2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommSchemeAE2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommSchemeAE2 = New RptCommSchemeAE2()
        rpt.Site = Me.Site
        Return rpt
    End Function
