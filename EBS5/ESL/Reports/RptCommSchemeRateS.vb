...
Public Class RptCommSchemeRateS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommSchemeRateS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommSchemeRateS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommSchemeRateS = New RptCommSchemeRateS()
        rpt.Site = Me.Site
        Return rpt
    End Function
