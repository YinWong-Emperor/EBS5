Public Class FrmRptCommCompareRebate

    Dim cls As New clsRptCommCompareRebate
    ...
    Private Sub FrmRptAeComm_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        Me.txtRange.Text = 0
        rbDiff_CheckedChanged(Nothing, System.EventArgs.Empty)
    End Sub
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        ae = Me.cboAE.Text
        display = Me.rbAll.Checked
        range = Me.txtRange.Text
        ...
        ElseIf Me.CheckBox2.Checked Then
            lstrSummary = "AE"
        End If
        rpt = cls.PrintTotalCommSRpt(txmonth, ae, display, range, lstrSummary)
    ...
    Private Sub rbDiff_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rbDiff.CheckedChanged
        Me.lblRange.Visible = rbDiff.Checked
        Me.txtRange.Visible = rbDiff.Checked
    End Sub
