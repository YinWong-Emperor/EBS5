...
Public Class FrmImportCRSCountryInfo
    Dim cls As New ClsImportCRSCountryInfo
    ...
    Private Sub btnLoadExcel_Click(sender As Object, e As EventArgs) Handles btnLoadExcel.Click
        ...
        Try
            ...
            If (openFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                ...
                If (GSubShowYNConfirm("Import Country Data? ")) = Windows.Forms.DialogResult.Yes Then
                    ...
                    dt = cls.lFncGetCountryDataFromExcel(filename)
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Import Country Data Failed. Please Retry.", "Country Data", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
    End Sub
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Try
            Using myProcess As New Process()
                myProcess.StartInfo.FileName = "\\ebs.uat.ecg.eguat.net\UAT\Sample_CountryData.xlsx"
                myProcess.Start()
            End Using
