Public Class frmAutoMatch
    ...
    Private Sub frmAutoMatch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        rpt = cls.FncGenReport(Format(CDate(Me.dtpTrade.Text.Trim), "yyyy/MM/dd"))
        'rpt = cls.FncGenRpt(txnDate, targetDt, Me.ckbShowDetail.Checked, dt1, Me.ambBLA.Text, Me.ambCLC.Text, Me.rbtFRR.Checked, Me.txtRemark.Text)
