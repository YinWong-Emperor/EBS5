Public Class FrmRptNotOptedOutClientList
    Private cls As New ClsRptNotOptedOutClientList
    ...
    '        Dim strRptTitle = "Not Opted-Out Client List"
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Dim orderBy As String = ""
        Dim targetDB As String = ""
        Dim strExFile As String = "NotOptedOutClientList"

        If rbG2bf.Checked = True Then
            'targetDB = GStrG2BFDB
            targetDB = GStrG2BFPRODDB
            strExFile = "NotOptedOutClientList_g2bf.csv"
        ElseIf rbG2bs.Checked = True Then
            'targetDB = GStrG2BSDB
            targetDB = GStrG2BSPRODDB
            strExFile = "NotOptedOutClientList_g2bs.csv"
        End If
