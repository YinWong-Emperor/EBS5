Public Class FrmClientProfile
    ...
    Dim cls As New ClsClientProfile
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        Else
            ...
            If ldtsTemp.Tables(0).Rows.Count > 0 Then
                ...
                Me.txtOccupation.Text = ldtwTemp("occupation")
                Me.txtIncome.Text = ldtwTemp("income")
                Me.cbCapital.Checked = ldtwTemp("capital_preservative")
                Me.cbSpeculative.Checked = ldtwTemp("speculative")
                Me.cbGrowth.Checked = ldtwTemp("growth")
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If (accno = "") Then
            ...
            Me.txtAcc.Focus()
        Else
            sqlstr = "'" & Me.txtAcc.Text & "','" & Me.txtMargin.Text & "','" & Me.txtName.Text & "','" & Me.txtOccupation.Text & _
                        "'," & Me.txtIncome.Text & ","
