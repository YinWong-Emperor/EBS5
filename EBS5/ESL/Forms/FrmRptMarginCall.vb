...
Public Class FrmRptMarginCall
    Dim loadFlag As Boolean = True
    Dim cls As New ClsMrgCall
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        rpt = cls.lFncPrintMarginCall2(lstrSQL, lstrSort, lstrTitle, MarginCAmt)
    ...
    Private Sub lsubExport(ByVal strQuery As String, ByVal strSort As String, ByVal MC As String)
        ...
        'If GSubShowYNConfirm(GFncGetSysMsg(27) & " To " & Me.CBExport.Text, MessageBoxDefaultButton.Button2) _
        ...
        Try
            ...
            lsWriter.WriteLine(lstrColValue)
            lsWriter.Flush()
            ldtsDetailData = cls.lFncPrepareMC2(strQuery, strSort, MC)
    ...
    Private Sub lSubToExcel(ByVal strQuery As String, ByVal strSort As String, ByVal MC As String)
        ...
        'If GSubShowYNConfirm(GFncGetSysMsg(27) & " To " & Me.txtPathXLS.Text, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
        '    Return
        'End If

        MCTbl = cls.lFncPrepareMC2(strQuery, strSort, MC)
        ...
        Try
            ...
            For row As Integer = 0 To MCTbl.Rows.Count - 1
                ...
                xlWorkSheet.Cells(row + 3, 11) = IIf(MCTbl.Rows(row).Item("liq_day") > 14, ">14", GFncNoNullValue(MCTbl.Rows(row).Item("liq_day")))
    ...
    'Private Function lFncRickFactor(ByVal AR As Double, ByVal Due As String, ByVal Deb_Bal As Double) As Integer
    ...
    'Private Function lFncDue(ByVal McDue As Double, ByVal Undue As Double) As String
