Public Class FrmRptTransAdj

    Dim cls As New ClsRptTransAdj
    ...
    Private Sub FrmNewedgeDiffRpt_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        Next
        For i As Integer = Val(txmonth.Substring(0, 4)) - 5 To Val(txmonth.Substring(0, 4)) + 5
            Me.CboYr.Items.Add(i)
        Next
        'Me.DtDate.Text = cls.GetLatestDateComm()
        'cls.GetLatestDate(Me.CboYr.Text, Me.CboMonth.Text)
        Me.CboMonth.Text = Val(txmonth.Substring(4, 2))
        Me.CboYr.Text = Val(txmonth.Substring(0, 4))
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Me.RBTradeRpt.Checked Then
            rpt = cls.PrintTranSRpt(Me.CboYr.Text & Format(CInt(Me.CboMonth.Text), "00"))
        ElseIf Me.RBTA_futRpt.Checked Then
            rpt = cls.PrintTranFRpt(Me.CboYr.Text & Format(CInt(Me.CboMonth.Text), "00"))
        End If
