Public Class FrmFuturesStatementOPAdj

    Private gCls As New clsFuturesStatementOPAdj
    ...
    Private Sub FrmFuturesStatementOPAdj_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.dgvQryResult.Columns.Item("qry_closingPrice").DefaultCellStyle = dgvDecimalPlacesCellStyle
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Dim lcAdjOpId As String = gAdjOpId
        ...
        If gAdjNoId = "" AndAlso gAdjOpId = "" Then
            If dgvQryResult.RowCount > 0 Then
                dgvQryResult.Rows(0).Selected = True
            End If
        ElseIf gAdjNoId <> "" AndAlso gAdjOpId <> "" Then
            Dim lcDrs As DataRow() = dt.Select("adjnoid='" & gAdjNoId & "' and opnoid='" & gAdjOpId & "'")
    ...
    Private Sub EnableAdjObj(ByVal pEnabled As Boolean)
        ...
        Me.txtAdj_ClosingPrice.Enabled = pEnabled
        Me.txtAdj_Floating.Enabled = pEnabled
    ...
    Private Sub ClearFieldData()
        ...
        Me.txtAdj_ClosingPrice.Text = ""
        Me.txtAdj_Floating.Text = ""
        ...
        Me.txtAdj_ClosingPrice_Org.Text = ""
        Me.txtAdj_Floating_Org.Text = ""
        Me.txtAdj_Buy_Sum.Text = ""
        Me.txtAdj_Sell_Sum.Text = ""
        Me.txtAdj_Price_Sum.Text = ""
        Me.txtAdj_ClosingPrice_Sum.Text = ""
        Me.txtAdj_Floating_Sum.Text = ""
    ...
    Private Sub ShowAddInfo(ByVal pIdx As Integer)
        Dim lcOpNoId As String = ""
        Dim lcAdjNoId As String = ""
        If Not IsNothing(Me.dgvQryResult.CurrentRow) And pIdx >= 0 Then
            lcOpNoId = GFncNoNullString(Me.dgvQryResult.Rows(pIdx).Cells("qry_opNoId").Value)
            lcAdjNoId = GFncNoNullString(Me.dgvQryResult.Rows(pIdx).Cells("qry_AdjNoId").Value)
        End If
        Dim dt As DataTable = Nothing

        Me.txtAdj_AdjNoId.Text = lcAdjNoId
        Me.txtAdj_OpNoId.Text = lcOpNoId
        ...
        Else
            ...
            Me.txtAdd_ClosingPrice.Text = GFncNoNullValue(dt.Rows(0).Item("closing_Price")).ToString(modGlobal.DecimalFormat)
    ...
    Private Sub ShowModificationInfo(ByVal pIdx As Integer)
        ...
        If lcOpNoId <> "" Then
            dt_org = gCls.GetOrginalData(lcOpNoId)
        End If
        If lcAdjNoId <> "" Then
            dt = gCls.GetAdjustedData(lcAdjNoId)
        End If
        ...
        Else
            ...
            Me.txtAdj_ClosingPrice_Org.Text = GFncNoNullValue(dt_org.Rows(0).Item("closing_Price")).ToString(modGlobal.DecimalFormat)
            Me.txtAdj_Floating_Org.Text = GFncNoNullValue(dt_org.Rows(0).Item("floating"))
        ...
        Else
            ...
            Me.txtAdj_ClosingPrice.Text = GFncNoNullValue(dt.Rows(0).Item("closing_Price")).ToString(modGlobal.DecimalFormat)
            Me.txtAdj_Floating.Text = GFncNoNullValue(dt.Rows(0).Item("floating"))
        ...
        txtAdj_Floating_Validated(Nothing, Nothing)
    End Sub
    ...
    Private Function ValidateInput() As Boolean
        ...
        Else
            ...
            If Me.txtAdj_AdjNoId.Text = "" AndAlso Me.txtAdj_OpNoId.Text = "" Then
    ...
    Private Function AddAdjustment() As Boolean
        ...
        Dim lcClosing As String = GFncNoNullString(Me.txtAdd_ClosingPrice.Text).Replace(",", "")
        Dim lcFloating As String = GFncNoNullString(Me.txtAdd_Floating.Text).Replace(",", "")
        ...
        If gCls.InsertAdjustmentRecord(-1, "A", GFncSqlQuote(lcAdjRemark), lcTDate, lcODate, lcBuy, _
            lcSell, lcMonthCode, lcProduct, lcPrice, lcClosing, lcFloating, lcSettleDate, lcMonthlyDaily, lcContractSize, lcCounterParty, lcCallPut, lcStrike) Then
            gSearchDate = lcTDate
            gAdjNoId = ""
            gAdjOpId = "-1"
    ...
    Private Function ModifyAdjustment() As Boolean
        ...
        If gCls.IsDeletedAdjustment(GFncNoNullString(Me.txtAdj_OpNoId.Text), GFncNoNullString(Me.txtAdj_AdjNoId.Text)) Then
        ...
        Dim lcClosing As String = ""
        Dim lcFloating As String = ""
        ...
        If gAdjAction = "A" Then
            ...
            lcClosing = GFncNoNullValue(GFncNoNullString(Me.txtAdd_ClosingPrice.Text).Replace(",", ""))
            lcFloating = GFncNoNullValue(GFncNoNullString(Me.txtAdd_Floating.Text).Replace(",", ""))
            ...
            If lcCallPut <> "" Then
                lcCallPut.Substring(0, 1)
            End If
            lcStrike = GFncNoNullString(Me.txtAdd_Strike.Text)
        Else
            lcAdjNoId = GFncNoNullString(Me.txtAdj_AdjNoId.Text)
            lcOpNoId = GFncNoNullString(Me.dgvQryResult.CurrentRow.Cells("qry_opNoId").Value)
            ...
            lcClosing = GFncNoNullValue(GFncNoNullString(Me.txtAdj_ClosingPrice.Text).Replace(",", ""))
            lcFloating = GFncNoNullValue(GFncNoNullString(Me.txtAdj_Floating.Text).Replace(",", ""))
        ...
        Dim lcTargerAdjNoId As String = gCls.CheckExistAdjustment(lcOpNoId, lcAdjNoId)

        If lcTargerAdjNoId = "" Then
            If gCls.IsNewAddedAdjustment(Me.txtAdj_AdjNoId.Text) Then
                If gCls.UpdateAdjustmentRecord(lcAdjNoId, "A", GFncSqlQuote(lcAdjRemark), lcTDate, lcODate, lcBuy, _
                    lcSell, lcMonthCode, lcProduct, lcPrice, lcClosing, lcFloating, lcSettleDate, lcMonthlyDaily, lcContractSize, lcCounterParty, lcCallPut, lcStrike) Then
                    gSearchDate = lcTDate
                    gAdjNoId = lcAdjNoId
                    gAdjOpId = lcOpNoId
                ...
                End If
            Else
                If gCls.InsertAdjustmentRecord(lcOpNoId, "M", GFncSqlQuote(lcAdjRemark), lcTDate, lcODate, lcBuy, _
                    lcSell, lcMonthCode, lcProduct, lcPrice, lcClosing, lcFloating, lcSettleDate, lcMonthlyDaily, lcContractSize, lcCounterParty, lcCallPut, lcStrike) Then
                    gSearchDate = lcTDate
                    gAdjNoId = lcAdjNoId
                    gAdjOpId = lcOpNoId
    ...
    Private Function DeleteAdjustment(ByVal pRemark As String) As Boolean
        ...
        If Not gCls.IsNewAddedAdjustment(Me.txtAdj_AdjNoId.Text) Then
            Dim lcTargetAdjNoId As String = gCls.CheckExistAdjustment(lcOpNoId, GFncNoNullString(Me.txtAdj_AdjNoId.Text))
            ...
            If lcTargetAdjNoId <> "" Then
                ...
                End If
            Else
                If gCls.InsertAdjustmentRecord(lcOpNoId, "D", GFncSqlQuote(lcAdjRemark), lcTDate, lcODate, lcBuy, _
                lcSell, lcMonthCode, lcProduct, lcPrice, lcClosing, lcFloating, lcSettleDate, lcMonthlyDaily, lcContractSize, lcCounterParty, lcCallPut, lcStrike) Then
                    gAdjNoId = ""
                    gAdjOpId = ""
                    GSubShowWarn(GFncGetSysMsg(13))
    ...
    Private Sub txtAdj_ClosingPrice_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtAdj_ClosingPrice.Validated
        If txtAdj_ClosingPrice.Text.Trim = "" Then
            txtAdj_ClosingPrice.Text = 0.0
        End If
        If txtAdj_ClosingPrice_Org.Text.Trim = "" Then
            txtAdj_ClosingPrice_Org.Text = 0.0
        End If
        Me.txtAdj_ClosingPrice.Text = GFncNoNullValue(Me.txtAdj_ClosingPrice.Text).ToString(modGlobal.DecimalFormat)
        Me.txtAdj_ClosingPrice_Sum.Text = (GFncNoNullValue(Me.txtAdj_ClosingPrice.Text) + GFncNoNullValue(txtAdj_ClosingPrice_Org.Text)).ToString(modGlobal.DecimalFormat)
    End Sub

    Private Sub txtAdj_Floating_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtAdj_Floating.Validated
        If txtAdj_Floating.Text.Trim = "" Then
            txtAdj_Floating.Text = 0.0
        End If
        If txtAdj_Floating_Org.Text.Trim = "" Then
            txtAdj_Floating_Org.Text = 0.0
        End If
        Me.txtAdj_Floating_Sum.Text = GFncNoNullValue(Me.txtAdj_Floating.Text) + GFncNoNullValue(txtAdj_Floating_Org.Text)
    End Sub
    ...
    Private Sub cboCallPut_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles cboCallPut.SelectedIndexChanged
