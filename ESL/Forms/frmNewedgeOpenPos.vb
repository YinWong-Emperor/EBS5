Public Class frmNewedgeOpenPos

    Dim rpt As CrystalDecisions.CrystalReports.Engine.ReportClass = Nothing
    Dim frm As New FrmRptDisplay
    Dim cls As New clsNewedgeOpenPosition

    Private Sub frmNewedgeOpenPos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        rpt = cls.FncGenReport(Me.dtpTrade.Value, Me.cbxCounterParty.Text)
