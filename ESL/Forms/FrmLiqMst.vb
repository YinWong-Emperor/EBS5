...
Public Class FrmLiqMst
    ...
    Private Sub FrmLiqMst_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub lsubDisplay(ByVal lstrType As String)
        ldtsDetail = cls.lFncGetDetail(lstrType)
        ldtsTotal = cls.lFncGetTotal(lstrType)
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        End If
        rpt = cls.lFncPrintAccLst(lstrSQL, lstrTitle)
    ...
    Private Sub TabControl1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TabControl1.SelectedIndexChanged
        ...
        If Me.TabControl1.SelectedIndex = 4 Then
            Me.MyTextbox1.Text = "c:\itas\liquidation_list.csv"
            Me.MyButton2.Focus()
        End If
    End Sub
    ...
    Private Sub MyButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyButton2.Click
        ...
        If GSubShowYNConfirm(GFncGetSysMsg(27) & " To c:\itas\liquidation_list.csv") _
                = Windows.Forms.DialogResult.Yes Then

            Try

                strFiles = System.IO.Directory.GetFiles("c:\itas\", "liquidation_list.csv")
                For Each strFile As String In strFiles
                    Application.DoEvents()
                    System.IO.File.Delete(strFile)
                Next

                'lsWriter = New StreamWriter("c:\itas\liquidation_list.csv")
                lsWriter = New StreamWriter("c:\itas\liquidation_list.csv", False, System.Text.Encoding.GetEncoding(950))
                ...
                lsWriter.Flush()
                If Me.RBMargin.Checked Then
                    ldtsDetailData = cls.lFncGetDetailData("M")
                ElseIf Me.RBCash.Checked Then
                    ldtsDetailData = cls.lFncGetDetailData("C")
                ElseIf Me.RBFinance.Checked Then
                    ldtsDetailData = cls.lFncGetDetailData("F")
                Else
                    ldtsDetailData = cls.lFncGetDetailData("")
                End If
