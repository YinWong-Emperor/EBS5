Public Class FrmCommAdjF

    Dim cls As New ClsCommAdjF
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Else
            ...
            strExFile = "Commission_Futures_" & CStr(Me.nudYear.Value) & "_" + mth + Format(Now(), "_yyyyMMddhhmmss") & ".csv"
    ...
    Private Sub btnAdjSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdjSave.Click
        ...
        If (GSubShowYNConfirm(GFncGetSysMsg(10)) = Windows.Forms.DialogResult.Yes) Then
            If (cls.lFncSaveAdj(Me.txtAdjClient.Text, adjYear, adjMonth, Me.txtAdjAdj.Text)) Then
                ...
                Me.txtAdjTtl.Text = CDbl(Me.txtAdjComm.Text) + CDbl(Me.txtAdjAdj.Text)
            End If
        Else
            Me.txtAdjAdj.Focus()
        End If
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If (cls.FncIsClientCodeExist(strCC) = False) Then
    ...
    Private Sub FrmCommAdjF_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub tc_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tc.SelectedIndexChanged
        ...
        ElseIf (Me.tc.SelectedIndex = 1) Then
            ...
            Me.txtAdjTtl.Text = Me.dtgDetail.Item(5, Me.dtgDetail.CurrentRow.Index).Value
            Me.lblAdjInfo.Text = ""
        Else
            Me.txtAddClient.Text = ""
            Me.nudAddYear.Value = GDteTradeDate.AddMonths(-1).Year
    ...
    Private Sub GetTotal()
        ...
        Dim total As Decimal = Convert.ToDecimal(Me.txtAdjComm.Text) + Me.txtAdjAdj.Value
