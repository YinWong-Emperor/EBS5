...
Public Class rptStockMonitor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptStockMonitor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paraShowMatch() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStockMonitor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockMonitor = New rptStockMonitor()
        rpt.Site = Me.Site
        Return rpt
    End Function
