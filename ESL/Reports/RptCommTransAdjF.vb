...
Public Class RptCommTransAdjF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommTransAdjF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommTransAdjF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommTransAdjF = New RptCommTransAdjF()
        rpt.Site = Me.Site
        Return rpt
    End Function
