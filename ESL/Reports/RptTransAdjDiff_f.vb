...
Public Class RptTransAdjDiff_f
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptTransAdjDiff_f.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTransAdjDiff_f
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTransAdjDiff_f = New RptTransAdjDiff_f()
        rpt.Site = Me.Site
        Return rpt
    End Function
