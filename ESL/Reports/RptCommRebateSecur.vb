...
Public Class RptCommRebateSecur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommRebateSecur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommRebateSecur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommRebateSecur = New RptCommRebateSecur()
        rpt.Site = Me.Site
        Return rpt
    End Function
