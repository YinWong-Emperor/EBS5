...
Public Class rptNewedgePloatingPLSub
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptNewedgePloatingPLSub.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptNewedgePloatingPLSub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewedgePloatingPLSub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewedgePloatingPLSub = New rptNewedgePloatingPLSub()
        rpt.Site = Me.Site
        Return rpt
    End Function
