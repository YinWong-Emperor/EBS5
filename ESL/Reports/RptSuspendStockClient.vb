...
Public Class RptSuspendStockClient
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptSuspendStockClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptSuspendStockClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paraTitle1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptSuspendStockClient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSuspendStockClient = New RptSuspendStockClient()
        rpt.Site = Me.Site
        Return rpt
    End Function
