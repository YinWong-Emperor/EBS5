...
Public Class rptCIES_Transaction
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCIES_Transaction.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptCIES_Transaction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCIES_Transaction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCIES_Transaction = New rptCIES_Transaction()
        rpt.Site = Me.Site
        Return rpt
    End Function
