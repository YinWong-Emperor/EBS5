...
Public Class rptAutoMatchG2BF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptAutoMatchG2BF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAutoMatchG2BF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAutoMatchG2BF = New rptAutoMatchG2BF()
        rpt.Site = Me.Site
        Return rpt
    End Function
