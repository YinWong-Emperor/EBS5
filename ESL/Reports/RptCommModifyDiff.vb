...
Public Class RptCommModifyDiff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommModifyDiff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommModifyDiff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommModifyDiff = New RptCommModifyDiff()
        rpt.Site = Me.Site
        Return rpt
    End Function
