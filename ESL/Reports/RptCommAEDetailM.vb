...
Public Class RptCommAEDetailM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommAEDetailM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommAEDetailM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommAEDetailM = New RptCommAEDetailM()
        rpt.Site = Me.Site
        Return rpt
    End Function
