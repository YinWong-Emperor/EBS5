...
Public Class RptCommAEDetailS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommAEDetailS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommAEDetailS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommAEDetailS = New RptCommAEDetailS()
        rpt.Site = Me.Site
        Return rpt
    End Function
