...
Public Class RptCommCompareRebate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptCommCompareRebate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommCompareRebate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ParaSummary() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptCommCompareRebate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommCompareRebate = New RptCommCompareRebate()
        rpt.Site = Me.Site
        Return rpt
    End Function
