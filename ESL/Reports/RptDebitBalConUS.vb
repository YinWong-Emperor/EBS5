...
Public Class RptDebitBalConUS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptDebitBalConUS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDebitBalConUS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDebitBalConUS = New RptDebitBalConUS()
        rpt.Site = Me.Site
        Return rpt
    End Function
