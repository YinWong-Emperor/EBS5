...
Public Class RptLog
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ParaDateRange() As CrystalDecisions.[Shared].IParameterField
        Get
