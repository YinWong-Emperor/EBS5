...
Public Class RptCommTransAdjS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommTransAdjS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommTransAdjS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommTransAdjS = New RptCommTransAdjS()
        rpt.Site = Me.Site
        Return rpt
    End Function
