...
Public Class RptCommMoidify_fut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommMoidify_fut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommMoidify_fut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommMoidify_fut = New RptCommMoidify_fut()
        rpt.Site = Me.Site
        Return rpt
    End Function
