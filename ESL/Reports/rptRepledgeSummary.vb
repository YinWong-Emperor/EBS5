...
Public Class rptRepledgeSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.rptRepledgeSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptRepledgerpt_user() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptRepledgeSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepledgeSummary = New rptRepledgeSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
