...
Public Class RptCommAEDetailF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESL.RptCommAEDetailF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCommAEDetailF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCommAEDetailF = New RptCommAEDetailF()
        rpt.Site = Me.Site
        Return rpt
    End Function
