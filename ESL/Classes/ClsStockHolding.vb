        ...
        If (GSubShowYNConfirm(GFncGetSysMsg(27)) = Windows.Forms.DialogResult.Yes) Then
            If (withDebit) Then
                lstrSQL = "select stock_code, sm.s_code, closing_price, sum(net_onhand_qty) as qty, " & _
                                    ...
                                    "from " & GStrG2BSDB & ".dbo.view_ER_client_master_mkt_mrg_value cm, " & _
                                    GStrG2BSDB & ".dbo.view_ER_client_portfolio cp, " & _
                                    GStrG2BSDB & ".dbo.stock_master sm, " & _
                                    GStrG2BSDB & ".dbo.currency_exchange ce, " & _
                                    GStrG2BSDB & ".dbo.currency_master cur, " & _
                                    " ( select distinct client_code from " & GStrG2BSDB & _
