...
Public Class myTextbox
    ...
    End Sub
    'compatibility for default value with Design-view
    ...
    'Protected Sub MyBase_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
