IF  EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[s_Get_CommAdjRpt]') AND TYPE IN (N'P', N'PC'))
...
-- Description : Search Procedure FOR CommssionAdjustReport
-- ============================================= */
